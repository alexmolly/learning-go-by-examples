...
import (
	...
	"github.com/alexmolly/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi"

	"github.com/alexmolly/learning-go-by-examples/go-rest-api/pkg/swagger/server/restapi/operations"
)
...
func GetGopherByName(gopher operations.GetGopherNameParams) middleware.Responder {
	...
	if gopher.Name != "" {
		...
		URL = "https://github.com/scraly/gophers/blob/main/dr-who.png"
	}
